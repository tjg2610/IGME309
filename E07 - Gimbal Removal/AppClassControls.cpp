...
#pragma endregion
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::X))
	{
		...
		{
			m_v3Rotation.x -= 1.0f;
			quaternion rotX = glm::angleAxis(glm::radians(-1.0f), vector3(1.0f, 0.0f, 0.0f));
			m_qOrientation = m_qOrientation * rotX;
		}
		else
		{
			m_v3Rotation.x += 1.0f;
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Y))
	{
		...
		{
			m_v3Rotation.y -= 1.0f;
			quaternion rotY = glm::angleAxis(glm::radians(-1.0f), vector3(0.0f, 1.0f, 0.0f));
			m_qOrientation = m_qOrientation * rotY;
		}
		else
		{
			m_v3Rotation.y += 1.0f;
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Z))
	{
		...
		{
			m_v3Rotation.z -= 1.0f;
			quaternion rotZ = glm::angleAxis(glm::radians(-1.0f), vector3(0.0f, 0.0f, 1.0f));
			m_qOrientation = m_qOrientation * rotZ;
		}
		else
		{
			m_v3Rotation.z += 1.0f;
